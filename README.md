...
│  🎭 AU Manager           [?]  [вкл/выкл]   │
│  ─────────────────────────────────────────  │
│  Все | Динамики | Связи | Сеттинг | ...     │
│  ─────────────────────────────────────────  │
│  [ Омегаверс         ] [ Пак-динамика    ]  │
│  [ Ханахаки          ] [ Телепатия       ]  │
│  ...                                        │
│  ─────────────────────────────────────────  │
│  Активно: ~450 токенов    [экспорт][импорт] │
└─────────────────────────────────────────────┘
```
...
- **SillyTavern** — десктоп и мобильная версия
- Использует нативный `Popup` ST — без внешних зависимостей
- Настройки сохраняются в `extension_settings` ST автоматически
